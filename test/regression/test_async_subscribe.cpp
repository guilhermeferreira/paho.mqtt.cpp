...
const std::string ADDRESS("tcp://m2m.eclipse.org:1883");
...
int main(int argc, char* argv[])
{
	...
	try {
		...
		mqtt::itoken_ptr conntok = client.connect(connOpts, nullptr, cb);
	...
	try {
		...
		mqtt::itoken_ptr conntok = client.disconnect();
		std::cout << "Waiting for the disconnection..." << std::endl;
		conntok->wait_for_completion();
		std::cout << "...OK" << std::endl;
	}
	catch (const mqtt::exception& exc) {

...
// ----------------------------------------------------------------------
	...
	void test_on_success() {
		...
		MQTTAsync_connectOptions& c_struct = co.get_c_struct();
...
// ----------------------------------------------------------------------
	...
	void test_on_failure_with_data() {
		...
		MQTTAsync_disconnectOptions& c_struct = dco.get_c_struct();
...
// ----------------------------------------------------------------------
	...
	void test_action_callback() {
		...
		MQTTAsync_responseOptions& c_struct = ro.get_c_struct();
